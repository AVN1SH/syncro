"use client";
import { FriendMessageWithUser, MessageWithMemberWithUser, PlainMember } from '@/types';
...
const ChatMessages = ({
  ...
  return (
    <div ref={chatRef} className="flex-1 flex flex-col py-4 overflow-y-auto scrollbar">
